...
2. **Patent Notice Requirement:** Any OpenClaw implementation must prominently display: *"PROTECTED BY PATENT PENDING (Priority Established 2026) Implementation permitted via exclusive grant to OpenClaw." and link back to the segregation_engine_core GitHug page (https://github.com/aiguysolutions/segregation_engine_core). *
3. **Non-Commercial:** This grant does not authorize commercial use or for-profit sublicensing by any party, including parent organizations or corporate sponsors.
4. **Non-Transferability:** This grant is specific to the open-source codebase of the OpenClaw Framework and does not extend to any proprietary, closed-source, or revenue-generating products of OpenClaw's sponsoring or parent organizations. Any commercial implementation by such entities requires a separate, negotiated license.
